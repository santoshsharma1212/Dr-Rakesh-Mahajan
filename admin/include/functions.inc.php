...
function generateShipRocketToken($con){
  ...
  curl_setopt_array($curl, array(
    ...
    CURLOPT_POSTFIELDS =>"{\n    \"email\": \"bharatjangraksl@gmail.com\",\n    \"password\": \"bharatksl\"\n}",
...
function placeShipRocketOrder($con,$token,$order_id){
  ...
  if(isset($SR_login_Response_out['order_id']) && isset($SR_login_Response_out['shipment_id'])){
	  ...
	  echo "<div class='shiprocket_error'>Order id:-".$ship_order_id."</div>";
	  echo "<div class='shiprocket_error'>Shipment id:-".$ship_shipment_id."</div>";
  }else{
	  $errroHTML='';
