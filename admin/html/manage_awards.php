...
if (isset($_GET['type']) && $_GET['type'] != '') {
    ...
    if ($type == 'status') {
        ...
        $update_status_sql = "update awards set status='$status' where id='$id'";
        mysqli_query($con, $update_status_sql);
    }

    if ($type == 'delete') {
        $id = get_safe_value($con, $_GET['id']);
        $delete_sql = "delete from awards where id='$id'";
...
<div class="page-breadcrumb">
    <div class="row">
        <div class="col-12 d-flex no-block align-items-center">
            <h4 class="page-title" style="margin-right:10px;"> Awards </h4>
            <span class=" add_button"> <a href="awards.php" class="btn btn-sm btn-primary"> Add Awards</a></span>
...
<div class="container-fluid" style=" height: calc(100vh - 120px);">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="box-title">Add Awards </h4>
                                ...
                                while ($row = mysqli_fetch_assoc($res)) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            echo "<a target='_blank' href='" . "../../Uploads/awards/" . $row['image'] . "'><img width='150px' src='" . "../../Uploads/awards/" . $row['image'] . "'/></a>";
                                            ?>
                                        </td>
                                        <td>
                                            <?php
                                            ...
                                            echo "<span class='badge1 badge-edit'><a href='awards.php?id=" . $row['id'] . "'>Edit</a></span>&nbsp;";
