...
<!-- Mirrored from figtheme.com/html/chirofind/appointment.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 02 Jul 2024 09:43:34 GMT -->
<head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title> Appointment || Chirofind || Chirofind HTML5 Template </title>
    <!-- favicons Icons -->
...
<body>
    ...
    <div class="page-wrapper">
        ...
        <section class="page-content-wrapper appointment-page">
            <div class="container">
                <div class="appointment-two__inner">
                    <div class="appointment-two__shape-1"></div>
                            ...
                            <div class="appointment-two__right">
                                <div class="section-title text-left">
                                    <div class="section-title__tagline-box">
                                        ...
                                        <span class="section-title__tagline">Book Appointment</span>
                                    </div>
                                    <h2 class="section-title__title">Book Now An Appointment</h2>
                                </div>
                                <form class="contact-form-validated appointment-two__form"
                                    action="https://figtheme.com/html/chirofind/assets/inc/sendemail.php" method="post" novalidate="novalidate">
                                    <div class="row">
                                        ...
                                        <div class="col-xl-6 col-lg-6">
                                            <div class="appointment-two__input-box">
                                                <input type="text" name="date" placeholder="Select Date"
                                                    id="datepicker">
                                                <div class="appointment-two__input-box-icon">
                                        ...
                                        <div class="col-xl-12">
                                            <div class="appointment-two__btn-box">
                                                <button type="submit" class="thm-btn appointment-two__btn">Appointment
                                                    Now<span class="icon-right-arrow"></span></button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
                    ...
                    <div class="appointment-two__img">
