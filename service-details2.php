...
<!-- Mirrored from figtheme.com/html/chirofind/massages-therapy.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 02 Jul 2024 09:43:24 GMT -->
<head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title> Massages Therapy || Chirofind || Chirofind HTML5 Template </title>
    <!-- favicons Icons -->
    <link rel="apple-touch-icon" sizes="180x180" href="assets/images/favicons/apple-touch-icon.png" />
    <link rel="icon" type="image/png" sizes="32x32" href="assets/images/favicons/favicon-32x32.png" />
    <link rel="icon" type="image/png" sizes="16x16" href="assets/images/favicons/favicon-16x16.png" />
    <link rel="manifest" href="assets/images/favicons/site.webmanifest" />
    <meta name="description" content="Chirofind HTML5 Template" />
    <!-- fonts -->
    ...
    <link rel="stylesheet" href="assets/vendors/chirofind-icons/style.css">
    <link rel="stylesheet" href="assets/vendors/bootstrap-select/css/bootstrap-select.min.css" />
    <link rel="stylesheet" href="assets/vendors/nice-select/nice-select.css" />
    <link rel="stylesheet" href="assets/vendors/jquery-ui/jquery-ui.css" />
    <link rel="stylesheet" href="assets/vendors/twenty-twenty/twentytwenty.css" />
    <!-- template styles -->
    <link rel="stylesheet" href="assets/css/chirofind.css" />
    <link rel="stylesheet" href="assets/css/chirofind-responsive.css" />
</head>
...
<body>
                ...
                <div class="main-menu-two__top-inner">
                    ...
                    <div class="main-menu-two__top-right">
                        <div class="main-menu-two__social-box">
                            <div class="main-menu-two__social-box-inner">
                                <h4 class="main-menu-two__social-box-title">Follow Us:</h4>
            ...
            <nav class="main-menu main-menu-two">
                <div class="main-menu-two__wrapper">
                    <div class="main-menu-two__wrapper-inner">
                        <div class="site-logo main-menu-two__logo">
                            ...
                            <div class="main-menu-two__main-menu-box">
                                <ul class="main-menu__list">
                                    ...
                                    <li class="dropdown">
                                        <a href="#">Services</a>
                                        <ul>
                                            <li><a href="services1.html">Services V-1</a></li>
                                            <li><a href="services2.html">Services V-2</a></li>
                                            <li><a href="trained-therapists.html">Trained Therapists</a></li>
                                            <li><a href="massages-therapy.html">Massages Therapy</a></li>
                                            <li><a href="chiropractic-care.html">Chiropractic Care</a></li>
                                            <li><a href="laser-therapy.html">Laser Therapy</a></li>
                                            <li><a href="physical-rehab.html">Physical Rehab</a></li>
                                        </ul>
                                    </li>
                                    <li class="dropdown">
                                        <a href="#">Pages</a>
                                        <ul>
                                            <li><a href="team1.html">Team V-1</a></li>
                                            <li><a href="team2.html">Team V-2</a></li>
                        ...
                        <div class="sidebar">
                            <div class="sidebar__single services-details__services-box">
                                ...
                                <ul class="services-details__services-list list-unstyled">
                                    <li>
                                        <a href="trained-therapists.html">Trained Therapists<span
                                                class="icon-right-arrow"></span></a>
                                    </li>
                                    <li class="active">
                                        <a href="massages-therapy.html">Massages Therapy<span
                                                class="icon-right-arrow"></span></a>
                                    </li>
                                    <li>
                                        <a href="chiropractic-care.html">Chiropractic Care<span
                                                class="icon-right-arrow"></span></a>
                                    </li>
                                    <li>
                                        <a href="laser-therapy.html">Laser Therapy<span
                                                class="icon-right-arrow"></span></a>
                                    </li>
                                    <li>
                                        <a href="physical-rehab.html">Physical Rehab<span
                                                class="icon-right-arrow"></span></a>
                                    </li>
                                </ul>
                            </div>
                    ...
                    <div class="col-xl-8 col-lg-7">
                        <div class="services-details__right">
                            ...
                            <div class="services-details__content">
                                <h3 class="services-details__title-1">Massages Therapy</h3>
                                <p class="services-details__text-1">Consectetur adipisicing elit, sed do eiusmod tempor
                                    is
                                    ...
                                    consequat.
                                    Duis aute irure and dolor in reprehenderit.</p>
                                <p class="services-details__text-2">The is ipsum dolor sit amet consectetur adipiscing
                                    elit.
                                    Fusce eleifend porta arcu In hac augu ehabitasse the is platea augue thelorem turpoi
                                    dictumst. In lacus libero faucibus at malesuada sagittis placerat eros sed
                                    istincidunt
                                    augue ac ante rutrum sed the is sodales augue consequat.</p>
                                <h3 class="services-details__title-2">Why Corrective Exercise</h3>
                                <p class="services-details__text-3">Nulla facilisi. Vestibulum tristique sem in eros
                                    eleifend imperdiet. Donec quis convallis neque. In id lacus pulvinar lacus, eget
                                    vulputate lectus. Ut viverra bibendum lorem, at tempus nibh mattis in. Sed a massa
                                    eget
                                ...
                                <div class="services-details__points-box">
                                    <ul class="services-details__points-list list-unstyled">
                                        <li>
                                            <div class="icon">
                                                <span class="icon-check-3"></span>
                                            </div>
                                            <p>Ut viverra bibendum lorem, at tempus </p>
                                        </li>
                                        <li>
                                            <div class="icon">
                                                <span class="icon-check-3"></span>
                                        ...
                                        <li>
                                            ...
                                            <p>Duis aute irure and dolor in reprehenderit.</p>
                                        </li>
                                        <li>
                                            <div class="icon">
                                                <span class="icon-check-3"></span>
                                            </div>
                                            <p>ante rutrum sed the is sodales augue</p>
                                        </li>
                                    </ul>
                                    <ul
                                        class="services-details__points-list services-details__points-list-2 list-unstyled">
                                        <li>
                                            <div class="icon">
                                                <span class="icon-check-3"></span>
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-xl-6">
                                            <div class="services-details__img-box-img">
                                                <img src="assets/images/services/services-details-img-box-img.jpg"
                                                    alt="">
                                            </div>
                                        </div>
                                        <div class="col-xl-6">
                                            <div class="services-details__img-box-img">
                                                <img src="assets/images/services/services-details-img-box-img-2.jpg"
                                                    alt="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <h3 class="services-details__title-3">Free Ask Question?</h3>
                                <p class="services-details__text-4">Consectetur adipisicing elit, sed do eiusmod tempor
                                    is incididunt ut labore et dolore of magna aliqua. Ut enim ad minim veniam, made of
                                ...
                                <div class="accrodion-grp faq-one-accrodion" data-grp-name="faq-one-accrodion-1">
                                    <div class="accrodion">
                                        ...
                                        <div class="accrodion-content">
                                            <div class="inner">
                                                <p>There are many variations of passages Lorem Ipsum but the
                                                    majority have
                                                    suffered alteration in some form, by injected humour.randomised
                                                    words
                                                    believable.
                                                </p>
                                            </div><!-- /.inner -->
        ...
        <section class="office-hours">
            ...
            <div class="container">
                <div class="office-hours-inner">
                    <div class="office-hours__content">
                        <h4 class="office-hours__content-title">Office Hours</h4>
                        <ul class="list-unstyled office-hours__list">
                            <li>
                                <p>Monday and Wednesday</p>
                                <p>8 AM - 2 PM, 4 PM - 7 PM</p>
                            </li>
                            <li>
                                <p>Friday</p>
                                <p>Closed</p>
                        ...
                        <div class="office-hours__btn-box">
                            <a href="appointment.html" class="office-hours__btn thm-btn">Appointment Now<span class="icon-right-arrow"></span></a>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="200ms">
                                <div class="footer-widget__column footer-widget__quick-link">
                                    ...
                                    <ul class="footer-widget__quick-link-list list-unstyled">
                                        ...
                                        <li><a href="appointment.html"><span class="icon-andle-dabble"></span>Appointment</a></li>
        ...
        <div class="mobile-nav__content">
            ...
            <ul class="mobile-nav__contact list-unstyled">
                <li>
                    ...
                    <a href="mailto:needhelp@chirofind.com">needhelp@chirofind.com</a>
                </li>
                <li>
            ...
            <div class="main-menu__btn-box-outer">
                <div class="main-menu__btn-box">
                    <a href="appointment.html" class="main-menu__btn thm-btn">
                        Appointment Now
    ...
    <!-- template js -->
    <script src="assets/js/chirofind.js"></script>
</body>
